...
import Turnos from '../Donante/Turnos';
...
function StackNavigation(props) {
    return (
        <StackNavigation>
            <Stack.Screen name='HomeHospital' options={{ headerShown: false }} {...props} >
                {() => <HomeHospital {...props} />}
            </Stack.Screen>
...
function MyProfileHospitalStackNavigation(props) {
  return (
    <Stack.Navigator>
        <Stack.Screen name='MyProfileHospital' options={{ headerShown: false }} {...props}>
            {() => <MyProfileHospital {...props} />}
...
export const TabScreenHosp = (props) => {
  ...
  console.log('ADENTRO DEL SCREEN HOSP');
  ...
  return (
    <Tab.Navigator shifting={true} activeColor="#A4161A" barStyle={{ backgroundColor: '#FFFFFF' }}>
        <Tab.Screen 
            name='Home' 
            options={{
                headerShown: false,
        ...
        <Tab.Screen 
            ...
            >
            {() => <MyProfileHospitalStackNavigation {...props} />}
        </Tab.Screen>
